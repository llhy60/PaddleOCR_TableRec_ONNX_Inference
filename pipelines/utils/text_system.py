...
class TextDetector(object):
    def __init__(self, args):
        ...
        self.preprocess_op = create_operators(pre_process_list)  # noqa: F405
        ...
        (
            ...
            self.output_tensors,
            self.config,
        ) = create_predictor(args, "det")  # noqa: F405
...
class TextRecognizer(object):
    def __init__(self, args):
        ...
        (
            ...
            self.output_tensors,
            self.config,
        ) = create_predictor(args, "rec")  # noqa: F405
        self.use_onnx = args.use_onnx
...
class TextClassifier(object):
    def __init__(self, args):
        ...
        (
            ...
            self.output_tensors,
            _,
        ) = create_predictor(args, "cls")  # noqa: F405
        self.use_onnx = args.use_onnx
